# @telia-oss/xjog-core-pglite

## 0.3.0

### Minor Changes

- f8a7acc: Extract a shared generic `AbstractPostgresPersistenceAdapter` (positional `$N` SQL over an abstract `runQuery` normalizer); core-pg/core-pglite keep only their driver layer (connect, transactions, death-note polling).
...
- Updated dependencies [012e4ae]
  - @telia-oss/xjog-core-persistence@0.2.0
